...
public class LearningHandwriteFragmentOrange extends Fragment {
    DrawCanvasView shadowCanvasV;
    Button btn2;
    List<Word> wordList = EWLADbHelper.WordList;

    public LearningHandwriteFragmentOrange() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_learning_handwrite_orange, container, false);
        btn2 = (Button)view.findViewById(R.id.button2);

        btn2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v){
                ((LearningActivity) getActivity()).onHandwriteNextButtonClick(v, wordList.get(7).getId()); }
        });
